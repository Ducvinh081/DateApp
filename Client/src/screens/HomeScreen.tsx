import { View, Text, Dimensions, TouchableOpacity, Image, Button, Platform } from "react-native";
import React, { useEffect, useState } from "react";
import { SafeAreaView } from "react-native-safe-area-context";
import {db} from "../../FirebaseConfig";
import {ref, set} from 'firebase/database';
import Carousal from "react-native-snap-carousel";
import DatesCard from "../components/List/DatesCard";
import {
  BellIcon,
...
const HomeScreen = () => {
  ...
  const getData = async () => {
    const UsersCollection = await set(ref(db, 'users/'),{
      user_id:,
      password: CgPassword,
    };
  }
